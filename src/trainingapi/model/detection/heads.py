...
from ..layers import XYWHA_XYWHA_BoxCoder
from ..layers import box_iou_rotated, batched_nms_rotated, remove_small_rotated_boxes

from .losses import rotated_faster_rcnn_loss
